...
function web3devpage() {
    ...
    let html = ` 
            ...
            <div class="flex glass flex-wrap -m-4 my-2" id="web3devcontainer">
              <div class=" mx-10 my-4 glass md:w-1/4" id="solidity">
                <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                  ...
                  <div class="p-6">
                    ...
                    <p class="leading-relaxed mb-3"> Solidity smartcontract web 3 dev</p>
                    <div class="flex items-center flex-wrap ">
              ...
              <div id="solana" class=" mx-10 my-4 glass md:w-1/4">
                <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                  <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="img/website.svg" alt="blog">
                  <div class="p-6">
                    <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY</h2>
